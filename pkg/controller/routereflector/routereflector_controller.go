...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	return &ReconcileRouteReflector{client: mgr.GetClient(), scheme: mgr.GetScheme()}
}
...
func (r *ReconcileRouteReflector) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	reqLogger.Info("Reconciling RouteReflector")

	// Fetch the RouteReflector instance
	instance := &routereflectorv1.RouteReflector{}
	...
	// Set RouteReflector instance as the owner and controller
...
func newPodForCR(cr *routereflectorv1.RouteReflector) *corev1.Pod {
